---
name: skill-creator
description: Guide for creating NEW skills from scratch. This skill should be used when users want to create a new skill or scaffold a skill directory. Triggers on "create a skill", "new skill", or "scaffold skill". Do NOT use for updating existing skills - use claude-code-expert instead.
